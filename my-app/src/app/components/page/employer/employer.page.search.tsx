            ...
            <div className="row">
                <div className="col-md-4 col-xs-12 mb-2">
                    <div className="form-group">
                        <label className="form-label" htmlFor="simpleinput">Tên Khách Hàng</label>
                        <input type="text" name="product_name" className="form-control" placeholder="Tên khách hàng" />
                    </div>
                </div>
